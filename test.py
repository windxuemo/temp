...
string.append("模拟WEB测试污点分析接口:第一次交互")
string.append("模拟WORK测试污点分析接口:第二次交互")

string.append("模拟WEB测试议符号执行接口:第一次交互")
string.append("模拟WORK测试议符号执行接口:第二次交互")
data = {}
interface = {}
web_test=[upload_1_web,install_1_web,static_1_web,network_1_web, taint_1_web, symbolic_1_web]
work_test=[install_2_work,static_2_work,network_2_work, taint_2_work, symbolic_2_work]
...
data[symbolic_1_web] = {
    "id":"01",
    "action":"symbolic",
    "proc_path": "/home/test/soft/self_test/server",
    "proc_args": "-p 21",
    "target_ip": "127.0.0.1",
    "plugin_script": "http://127.0.0.1:9000/plugin_script.py",
    "client_script": "http://127.0.0.1:9000/client_script.py"
}
...
interface[taint_1_web] = "/dispatch/taint"
interface[taint_2_work] = "/api/ReceiveData/NetworkBasic"

interface[symbolic_1_web] = "/dispatch/symbolic"
interface[symbolic_2_work] = "/api/ReceiveData/NetworkBasic"
